...
Traceback (most recent call last):
  ...
  File "/home/nate/github/scrape_stocks/scrape_stockdata.py", line 588, in scrape_a_ticker_mongo
...
~/github/scrape_stocks/scrape_stockdata.py in daily_scrape_data()
    636                 if today_utc.hour > open_days.loc[today_utc.date()]['market_close'].hour:
...
--> 549         if r.result() is not None:
    ...
    551     # old way of doing it, and wasn't working great
