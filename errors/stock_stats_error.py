...
Traceback (most recent call last):
  ...
  File "/home/nate/github/scrape_stocks/scrape_stockdata.py", line 556, in scrape_all_tickers_mongo_paral
lel
...
Traceback (most recent call last):
  File "/usr/local/lib/python3.5/dist-packages/IPython/core/interactiveshell.py", line 1828, in showtrace
back
...
File "/usr/local/lib/python3.5/dist-packages/IPython/core/ultratb.py", line 345, in _fixed_getinnerfram
es
...
/usr/local/lib/python3.5/dist-packages/IPython/core/ultratb.py in structured_traceback(self, etype, evalu
e, etb, tb_offset, number_of_lines_of_context)
