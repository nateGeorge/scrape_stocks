...
--> 321             username = driver.find_element_by_xpath('/html/body/div/table[5]/tbody/tr/
td/div/table/tbody/tr/td/form/table/tbody/tr[1]/td[2]/input')
    322             password = driver.find_element_by_xpath('/html/body/div/table[5]/tbody/tr/
td/div/table/tbody/tr/td/form/table/tbody/tr[2]/td[2]/input')

/usr/local/lib/python3.6/dist-packages/selenium/webdriver/remote/webdriver.py in find_element_
by_xpath(self, xpath)
    384         """
--> 385         return self.find_element(by=By.XPATH, value=xpath)
    386

/usr/local/lib/python3.6/dist-packages/selenium/webdriver/remote/webdriver.py in find_element(
self, by, value)
    954             'using': by,
--> 955             'value': value})['value']
    956

/usr/local/lib/python3.6/dist-packages/selenium/webdriver/remote/webdriver.py in execute(self,
 driver_command, params)
    311         if response:
--> 312             self.error_handler.check_response(response)
    313             response['value'] = self._unwrap_value(

/usr/local/lib/python3.6/dist-packages/selenium/webdriver/remote/errorhandler.py in check_resp
onse(self, response)
    241             raise exception_class(message, screen, stacktrace, alert_text)
--> 242         raise exception_class(message, screen, stacktrace)
    243

NoSuchElementException: Message: Unable to locate element: /html/body/div/table[5]/tbody/tr/td
/div/table/tbody/tr/td/form/table/tbody/tr[1]/td[2]/input
...
~/github/scrape_stocks/scrape_shortsqueeze.py in <module>()
    ...
    345     time.sleep(3)  # wait for login to complete...could also use some element detectio
n
...
~/github/scrape_stocks/scrape_shortsqueeze.py in log_in(driver)
    ...
    320             time.sleep(1 + np.random.rand())  # should add WebDriverWait
--> 321             username = driver.find_element_by_xpath('/html/body/div/table[5]/tbody/tr/td/div/table/tbody/tr/td/form/table/tbody/tr[1]/td[2]/input')
    322             password = driver.find_element_by_xpath('/html/body/div/table[5]/tbody/tr/td/div/table/tbody/tr/td/form/table/tbody/tr[2]/td[2]/input')
...
NoSuchElementException: Message: Unable to locate element: /html/body/div/table[5]/tbody/tr/td/div/table/tbody/tr/td/form/table/tbody/tr[1]/td[2]/input
